...
export default  function EmergencyCare ()
{
    ...
    <>
       ...
       <Link href="/"> 
          ...
          <h2 style={{display:"flex", flexDirection:"row", alignItems:"center", gap:"5px"}} className="p-5 tracking-widest"> <span style={{color:"#00A94F"}}>Home</span> <svg xmlns="http://www.w3.org/2000/svg" width="6" height="11" viewBox="0 0 6 11" fill="none">
